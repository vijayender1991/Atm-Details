...
class EventTableViewController: UITableViewController, UISearchResultsUpdating {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.title = String(format: "ATM list (%i)", eventList.count)
    }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if resultSearchController.isActive {
            let secondViewController = self.storyboard?.instantiateViewController(withIdentifier: "detailedVC") as! DetailedVC
